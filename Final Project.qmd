...
Link to GitHub Repository: <https://github.com/keelinjoyce/334_final_project>
...
#### Future Work
This project can be further expanded to include future data and more comparisons between years as well as other athletes and teams to include more variability in the analysis. It can also be expanded to include more training pieces and go more in-depth on how practical winter training practices are (which are most efficient).
